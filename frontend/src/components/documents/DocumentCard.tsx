  ...
  return (
    ...
    >
      ...
      >
        ...
        {document.chunks_indexed != null && document.chunks_indexed > 0 && (
          <>
            <span style={{ color: 'rgba(148, 163, 184, 0.35)' }}>Chunks</span>
            <span className="text-right" style={{ color: '#34d399', fontFamily: "'JetBrains Mono', monospace" }}>
