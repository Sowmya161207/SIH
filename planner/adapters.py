...
class MockPlannerLLMClient(BasePlannerLLMClient):
    ...
    async def complete(self, system_prompt: str, user_prompt: str) -> str:
        ...
        elif any(k in lower_query for k in ["pdf", "document", "uploaded", "file", "security mechanism", "policy", "report"]):
            plan_dict = {
                "intent": "document_qa",
                "requires_rag": True,
                "requires_web": False,
...
class MockLLMAgent(BaseLLMAgent):
    ...
    async def generate(
        ...
        # If context is provided (from RAG or Web Search)
        ...
        # Direct general queries without context
