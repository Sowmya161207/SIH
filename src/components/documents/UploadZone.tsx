...
export const UploadZone: React.FC<UploadZoneProps> = ({
  ...
  const validateFile = (file: File): boolean => {
    ...
    if (file.size > maxFileSizeBytes) { setValidationError('File exceeds 20 MB limit.'); return false; }
    return true;
  };
    ...
    >
      ...
      {uploadSuccess && (
        ...
        >
          ...
          <div>
            <p className="text-xs font-semibold" style={{ color: '#34d399' }}>Indexed Successfully</p>
            <p className="text-xs mt-0.5" style={{ color: 'rgba(52, 211, 153, 0.6)' }}>Document is being processed.</p>
          </div>
        </div>
      )}
